...
{
    public abstract class UnaryComparisonOperator : Operator
    {
        ...
        private DataSetType PerformCalculation(DataSetType dataSet)
        {
            ...
            {
                throw new Exception(
                    "Operatorn kan inte användas på datasetnivå om datasetet har mer än en measurekomponent.");
            }
