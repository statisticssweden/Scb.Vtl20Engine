...
namespace VTL.Vtl20Engine.Test.AggregateOperatorTests
{
    ...
    public class MinTests
    {
        ...
        [TestMethod]
        public void Min_ByOneComponent()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var DS_r = sut.Execute("DS_r <- min(DS_1 group by RefDate);", new[] { _ds_1 })
            ...
            using (var dataPointEnumerator = result.DataPoints.GetEnumerator())
            {
                ...
                Assert.AreEqual((NumberType) 200, dataPointEnumerator.Current[1]);
                Assert.AreEqual((NumberType) 0, dataPointEnumerator.Current[2]);
                ...
                Assert.AreEqual((NumberType) 310, dataPointEnumerator.Current[2]);
            }
        }

        [TestMethod]
        public void Min_GroupByTwoComponents()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var DS_r = sut.Execute("DS_r <- min(DS_1 group by RefDate,Id);", new[] { _ds_1 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
            ...
            using (var dataPointEnumerator = result.DataPoints.GetEnumerator())
            {
                ...
                Assert.AreEqual((StringType) "2013", dataPointEnumerator.Current[1]);
                Assert.AreEqual((NumberType) 200, dataPointEnumerator.Current[2]);
                Assert.AreEqual((NumberType) 0, dataPointEnumerator.Current[3]);
        ...
        [TestMethod]
        public void Min_GroupExceptOneComponent()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var DS_r = sut.Execute("DS_r <- min(DS_1 group except RefDate);", new[] { _ds_1 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
            ...
            using (var dataPointEnumerator = result.DataPoints.GetEnumerator())
            {
                ...
                Assert.AreEqual((NumberType) 217, dataPointEnumerator.Current[3]);
        ...
        [TestMethod]
        public void Min_GroupExceptTwoComponents()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var DS_r = sut.Execute("DS_r <- min(DS_1 group except RefDate,Id);", new[] { _ds_1 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
            ...
            using (var dataPointEnumerator = result.DataPoints.GetEnumerator())
            {
                ...
                Assert.AreEqual((NumberType) 805, dataPointEnumerator.Current[1]);
                Assert.AreEqual((NumberType) 200, dataPointEnumerator.Current[2]);
        ...
        [TestMethod]
        public void Min_ResultIsIntegerType()
        {
            var sut = new VtlEngine(new DataContainerFactory());
...

        {
            ...
            var DS_r = sut.Execute("DS_r <- min(DS_1 group by MeasName);", new[] { ds })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
            ...
            using (var dataPointEnumerator = result.DataPoints.GetEnumerator())
            {
                dataPointEnumerator.MoveNext();
                Assert.AreEqual((StringType)"Gross Prod.", dataPointEnumerator.Current[0]);
                Assert.AreEqual(new TimePeriodType(2000, Duration.Month, 1), dataPointEnumerator.Current[1]);
