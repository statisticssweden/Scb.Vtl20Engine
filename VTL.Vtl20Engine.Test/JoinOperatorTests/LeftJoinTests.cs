...
namespace VTL.Vtl20Engine.Test.JoinOperatorTests
{
    ...
    public class LeftJoinTests
    {
        ...
        [TestMethod]
        public void LeftJoin_Example2()
        {

            var sut = new VtlEngine(new DataContainerFactory());

            var dsr = sut.Execute("DS_r <- left_join(DS_1 as d1, DS_2 as d2 keep Me_1, d2#Me_2, Me_1A);", new[] { ds_1, ds_2 })
        ...
        [TestMethod]
        public void LeftJoin_NonMatchingComponents()
        {
            ds_1 = new Operand
            {
                Alias = "DS_1",
            ...
            Assert.ThrowsException<VtlException>(() => sut.Execute("DS_r <- left_join ( DS_1, DS_2 );", new[] { ds_1, ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r")));
        ...
        [TestMethod]
        public void LeftJoin_FilterThenKeep()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var dsr = sut.Execute("DS_r <- left_join ( DS_1, DS_2 filter Id_1 = 1 keep DS_2#Me_2);", new[] { ds_1, ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
        ...
        [TestMethod]
        public void LeftJoin_FilterThenKeepWithAlias()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var dsr = sut.Execute("DS_r <- left_join ( DS_1 as d1, DS_2 as d2 filter Id_1 = 1 keep d2#Me_2);", new[] { ds_1, ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
        ...
        [TestMethod]
        public void LeftJoin_FilterThenDrop()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var dsr = sut.Execute("DS_r <- left_join ( DS_1, DS_2 filter Id_1 = 1 drop DS_1#Me_1, DS_1#Me_2, DS_2#Me_1A);", new[] { ds_1, ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
        ...
        public void LeftJoin_FilterThenDropWithAlias()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var dsr = sut.Execute("DS_r <- left_join ( DS_1 as d1, DS_2 as d2 filter Id_1 = 1 drop d1#Me_1, d1#Me_2, d2#Me_1A);", new[] { ds_1, ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
        ...
        [TestMethod]
        public void LeftJoin_ThrowsException()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            Assert.ThrowsException<VtlException>(() => sut.Execute("DS_r <- left_join ( DS_1 as d1, DS_2 as d2 filter Id_1 = 1 keep Me_2);", new[] { ds_1, ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r")));
        }

        [TestMethod]
        public void LeftJoin_AfterCount1()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            Assert.ThrowsException<VtlException>(() => sut.Execute("A := count(DS_1 group by Id_1); DS_r <- left_join ( A, DS_2 rename DS_2#Me_2 to Me_2A);", new[] { ds_1, ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r")));

        }

        [TestMethod]
        public void LeftJoin_ThrowsExceptionWhenStructureNotCompatible()
        {
            ds_1 = new Operand
            {
                Alias = "DS_1",
        ...
        [TestMethod]
        public void LeftJoin_Using()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var dsr = sut.Execute("DS_r <- left_join(DS_1 as d1, DS_2 as d2 using Id_1 keep Me_1 rename d2#Id_2 to d2#Id_22);", new[] { ds_1, ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
            ...
            using (var dataPointEnumerator = result.DataPoints.GetEnumerator())
            {
                ...
                Assert.AreEqual(new IntegerType(2), dataPointEnumerator.Current[id_1]);
                Assert.AreEqual(new StringType("A"), dataPointEnumerator.Current[id_2]);
                Assert.IsFalse(dataPointEnumerator.Current[id_22].HasValue());
                Assert.AreEqual(new StringType("E"), dataPointEnumerator.Current[me_1]);
        ...
        [TestMethod]
        public void LeftJoin_Using2()
        {

            var sut = new VtlEngine(new DataContainerFactory());

            var dsr = sut.Execute("DS_r <- left_join(DS_1 as d1, DS_2 as d2 using Id_1, Id_2 keep Me_1, d2#Me_2, Me_1A);", new[] { ds_1, ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
        ...
        [TestMethod]
        public void LeftJoin_using_occupied_alias()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            Assert.ThrowsException<VtlException>(() => sut.Execute("DS_r <- left_join(DS_1 as d1, DS_2 as DS_r using Id_1, Id_2 keep Me_1, DS_r#Me_2, Me_1A);", new[] { ds_1, ds_2 }));
        }

        [TestMethod]
        public void LeftJoin_Using3()
        {
            ds_1 = new Operand
            {
                Alias = "DS_1",
        ...
        [TestMethod]
        public void LeftJoin_NonMatchingComponents2()
        {
