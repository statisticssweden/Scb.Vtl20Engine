...
namespace VTL.Vtl20Engine.Test.ComparisonOperatorTests
{
    ...
    public class LessThanOrEqualToTest
    {
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void LessThanOrEqualTo_Constant()
        {
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void LessThanOrEqualTo_DataSet()
        {
            var sut = new VtlEngine(new DataContainerFactory());
            ...
            using (var dataPointEnumerator = result.DataPoints.GetEnumerator())
            {
                ...
                dataPointEnumerator.MoveNext();
                Assert.AreEqual((BooleanType)true, dataPointEnumerator.Current[2]);//1000=<1000

                dataPointEnumerator.MoveNext();
                Assert.AreEqual((BooleanType)true, dataPointEnumerator.Current[2]);//200<=200
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void LessThanOrEqualTo_ConstantString()
        {
            var sut = new VtlEngine(new DataContainerFactory());
            ...
            using (var dataPointEnumerator = result.DataPoints.GetEnumerator())
            {
                ...
                Assert.AreEqual((StringType)"Gross Prod.", dataPointEnumerator.Current[0]);
                Assert.AreEqual((StringType)"2013", dataPointEnumerator.Current[1]);
                Assert.AreEqual((BooleanType)true, dataPointEnumerator.Current[2]);//ABC<=ABC
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void LessThanOrEqualTo_DataSetStringMeasure()
        {
            var sut = new VtlEngine(new DataContainerFactory());
            ...
            using (var dataPointEnumerator = result.DataPoints.GetEnumerator())
            {
                ...
                dataPointEnumerator.MoveNext();
                Assert.AreEqual((BooleanType)true, dataPointEnumerator.Current[2]);//ACC<=ACC
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void LessThanOrEqualTo_timePeriod()
        {
        ...
        public void lessthanorEqual_boolean()
        {
            ...
            Assert.AreEqual((BooleanType)true, fresult);
        }
    }
}
