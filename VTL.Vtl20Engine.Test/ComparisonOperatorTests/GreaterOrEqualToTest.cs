...
namespace VTL.Vtl20Engine.Test.ComparisonOperatorTests
{
    ...
    public class GreaterOrEqualToTest
    {
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void GreaterOrEqualTo_Constant()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var DS_r = sut.Execute("DS_r <- DS_1 >= 600;", new[] { _ds_1 })
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void GreaterOrEqualTo_DataSet()
        {
            var sut = new VtlEngine(new DataContainerFactory());
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void GreaterOrEqualTo_ConstantString()
        {
            var sut = new VtlEngine(new DataContainerFactory());
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void GreaterOrEqualTo_DataSetStringMeasure()
        {
            var sut = new VtlEngine(new DataContainerFactory());
            ...
            {
                dataPointEnumerator.MoveNext();
                Assert.AreEqual((BooleanType) false, dataPointEnumerator.Current[2]); //ABB>=ACB
                dataPointEnumerator.MoveNext();
                Assert.AreEqual((BooleanType) false, dataPointEnumerator.Current[2]); //ABC>=ACC
                dataPointEnumerator.MoveNext();
                Assert.AreEqual((BooleanType) false, dataPointEnumerator.Current[2]); //ACB>=ACC
                dataPointEnumerator.MoveNext();
                Assert.AreEqual((BooleanType) true, dataPointEnumerator.Current[2]); //ACC>=ABC
            }
        }
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void GreaterOrEqualTo_component()
        {
            var sut = new VtlEngine(new DataContainerFactory());
            var DS_r = sut.Execute(@"DS_r <- DS_1[calc Value2 := Value1 + 500 >= 1000];", new[] { _ds_1 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void GreaterOrEqualTo_timePeriod()
        {
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void GreaterThanorEqual_boolean()
        {
            var a = new Operand
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void GreaterThanorEqual_correctDatapointMatching()
        {
