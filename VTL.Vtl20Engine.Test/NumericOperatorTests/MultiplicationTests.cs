...
namespace VTL.Vtl20Engine.Test.NumericOperatorTests
{
    ...
    public class MultiplicationTests
    {
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_addTwoNumbers()
        {
            ...
            Assert.IsNotNull(c);
            Assert.AreEqual(2.0m, c);
        }

        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_addNumberAndNull()
        {
            var a = new Operand
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_addTwoNumbersWithVTLCode()
        {
            var a = new Operand
            { Alias = "a", Data = new NumberType(1.0m) };
            var b = new Operand
            ...
            Assert.AreEqual(2.0m, (NumberType)result);
        }
        
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_addNumberAndInteger()
        {
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_addNumberAndIntegerWithVTLCode()
        {
            var a = new Operand
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_addTwoIntegers()
        {
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_addTwoIntegersWithVTLCode()
        {
            var a = new Operand
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_multiLineVTLCode()
        {
            var a = new Operand
            { Alias = "a", Data = new IntegerType(1) };
            var b = new Operand
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_FiveIntegersWithVTLCode()
        {
            var a = new Operand
            { Alias = "a", Data = new IntegerType(1) };
            var b = new Operand
            ...
            Assert.IsTrue(result is IntegerType);
            Assert.AreEqual(54, (IntegerType)result);
        }

        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_AddAndMultiplyVTLCode()
        {
            var a = new Operand
            { Alias = "a", Data = new IntegerType(1) };
            var b = new Operand
            ...
            var c = sut.Execute("c <- 1 + a * b;", new[] { a, b }).FirstOrDefault(r => r.Alias.Equals("c"));
            var result = c.GetValue();
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_IntegerToInteger()
        {
            var a = new Operand
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Multiplication_DecimalToDecimal()
        {
            var a = new Operand
            { Alias = "a", Data = new NumberType(new decimal(2.5)) };
            var b = new Operand
            { Alias = "b", Data = new NumberType(new decimal(4.0)) };
            var sut = new VtlEngine(new DataContainerFactory());
        ...
        public void Minus_BooleanFriendlyErrorMessage()
        {
            ...
            Assert.AreEqual("Värdet False har datatypen BooleanType vilken inte är tillåten för operatorn Multiplication.", e.Message);
        }
        ...
        public void Minus_BooleanFriendlyErrorMessageDataSets()
        {
            ...
            Assert.AreEqual("Värdekomponenten Me_1 har datatypen BooleanType vilken inte är tillåten för operatorn Multiplication.", e.Message);
        }
