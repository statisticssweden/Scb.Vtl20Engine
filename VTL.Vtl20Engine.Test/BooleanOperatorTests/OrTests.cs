...
namespace VTL.Vtl20Engine.Test.BooleanOperatorTests
{
    ...
    public class OrTests
    {
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Or_datasets()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var DS_r = sut.Execute("DS_r <- DS_1 or DS_2;", new[] { _ds_1, _ds_2 })
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Or_datasetScalar()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var DS_r = sut.Execute("DS_r <- DS_1 or false;", new[] { _ds_1, _ds_2 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
        ...
        [TestCategory("Unit")]
        [TestMethod]
        public void Or_datasetsWithConditions()
        {
            var sut = new VtlEngine(new DataContainerFactory());

            var DS_r = sut.Execute("DS_r <- DS_1#Id_1 = \"M\" or DS_1#Id_2 > 30;", new[] { _ds_1 })
                .FirstOrDefault(r => r.Alias.Equals("DS_r"));
